...
# --- ENSAMBLADO DE LA NAVE ---

clean_scene()

# Cuerpo principal (CanTower)
body = create_cylinder("Body", radius=0.66, depth=1.22, location=(0, 0, 0.61))

# Torre central (ChipTower)
...
print(" Nave ensamblada en Blender")
